...
class Settings
{
	...
	public function new(font:String = null, fontSize:Int = 12, textFieldWidth:Float = 240, color:FlxColor = FlxColor.WHITE, numLines:Int = 3,
			charactersPerSecond:Float = 24, // This default value has been empirically chosen to work with only the fonts
